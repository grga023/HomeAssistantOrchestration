...
| `esp3_garage.puml`       | ESP3 garage door cover state machine |
| `esp4_security.puml`     | ESP4 alarm panel + door/motion + siren |

All boards share the boot/connectivity flow in `common_boot.puml`; each
